...
AutoConsume = Bad.Categories.Inventory:CreateModule({
	Name = 'AutoConsume',
	Function = function(callback)
		if callback then
			AutoConsume:Clean(BadEvents.InventoryAmountChanged.Event:Connect(consumeCheck))
			AutoConsume:Clean(BadEvents.AttributeChanged.Event:Connect(function(attribute)
