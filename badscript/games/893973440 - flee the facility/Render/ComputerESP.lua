...
ComputerESP = Bad.Categories.Render:CreateModule({
	Name = 'ComputerESP',
	Function = function(callback)
		if callback then
			ComputerESP:Clean(BadEvents.MapAdded.Event:Connect(MapAdded))
			ComputerESP:Clean(BadEvents.MapRemoved.Event:Connect(function()
