...
function EventHandlerUtils._initializeThread(memoryCategory: string): ()
	...
	if type(debugger) == "table" and type(debugger.setmemorycategory) == "function" then
		pcall(debugger.setmemorycategory, memoryCategory == "" and "signal_unknown" or memoryCategory)
	end
