...
local getcustomassets = {
	['badscript/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['badscript/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['badscript/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['badscript/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['badscript/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['badscript/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['badscript/assets/old/info.png'] = 'rbxasset://info.png',
	['badscript/assets/old/pin.png'] = 'rbxasset://pin.png',
	['badscript/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['badscript/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['badscript/assets/old/search.png'] = 'rbxasset://search.png',
	['badscript/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['badscript/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['badscript/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['badscript/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['badscript/assets/old/textBad.png'] = 'rbxasset://textBad.png',
	['badscript/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['badscript/assets/old/Bad.png'] = 'rbxassetid://14373395239',
	['badscript/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('badscript/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('badscript/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('badscript/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('badscript/assets/old/pin.png')
	...
	function categoryapi:ChangeValue(val)
		...
		for i, v in (categorysettings.Profiles and mainapi.Profiles or self.List) do
			if categorysettings.Profiles then
				...
				objectdotin.Image = getcustomasset('badscript/assets/old/checkbox.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('badscript/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('badscript/assets/old/Bad.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('badscript/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('badscript/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('badscript/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('badscript/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('badscript/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('badscript/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('badscript/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('badscript/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('badscript/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('badscript/assets/old/profilesicon.png'),
	...
	Function = function(val, mouse)
		if mouse then
			...
			if shared.BadDeveloper then
				...
				loadstring(game:HttpGet('https://raw.githubusercontent.com/evanbackup1256-ship-it/badwars/main/profiles/commit.txt')..'/loader.lua', true))()
			end
		end
	end,
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('badscript/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
BadLogoV4.Size = UDim2.fromOffset(43, 30)
BadLogoV4.Position = UDim2.new(1, 1, 0, -2)
BadLogoV4.BackgroundColor3 = Color3.new()
BadLogoV4.BackgroundTransparency = 1
BadLogoV4.BorderSizePixel = 0
BadLogoV4.Image = getcustomasset('badscript/assets/old/textv4.png')
...
function mainapi:UpdateTextGUI(afterload)
	...
	if textgui.Button.Enabled then
		...
		BadLogo.Position = right and UDim2.new(1 / BadTextScale.Scale, -141, 0, 4) or UDim2.fromOffset(5, 4)
		...
		BadLabelHolder.Position = UDim2.fromOffset(4, 4 + (BadLogo.Visible and BadLogo.Size.Y.Offset or 0))
...
function mainapi:UpdateGUI(hue, sat, val, default)
	...
	if textgui.Button.Enabled then
		...
		BadLogoGradient2.Color = mainapi.GUIColor.Rainbow and BadLogoGradient.Color or ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.new(1, 1, 1)),
			ColorSequenceKeypoint.new(1, Color3.new(1, 1, 1))
		})
		for i, v in BadLabels do
			v.Text.TextColor3 = customcolor or (mainapi.GUIColor.Rainbow and Color3.fromHSV(mainapi:Color((hue - ((i + 2) * 0.025)) % 1)) or BadLogoGradient.Color.Keypoints[2].Value)
		end
	end
