...
local function isStaleGuiCache(path, body)
    ...
    return body:find("BADWARS_UI_V20_2_1_BENTO", 1, true) == nil
        or body:find("BADWARS_UI_V20_2_1_BENTO_RUNTIME_BEGIN", 1, true) == nil
        or body:find("Version = \"20.2\"", 1, true) == nil
end
