...
local function rawUrls(path)
    ...
    local query='?bwui=v20-3-executive-1'
    return {
...
local cacheVersion = 'badwars-v20-3-executive-2026-07-06-01'
local cacheFile = 'badscript/profiles/cache-version.txt'
local function isCurrentGuiCache(contents)
    return type(contents) == "string"
        and contents:find("BADWARS_UI_V20_3_EXECUTIVE", 1, true) ~= nil
        and contents:find("BADWARS_UI_V20_3_EXECUTIVE_RUNTIME_BEGIN", 1, true) ~= nil
        and contents:find("Version = \"20.3\"", 1, true) ~= nil
end
