-- BADWARS_MASSIVE_PRESENTATION_OVERHAUL_2026_07_05
...
local d = {
    ...
    BindNotifications = {},
    Version = "4.18",
    PremiumBuild = "2026.07.05-BADWARS-EXE6-INSPIRED-UI",
    Windows = {},
    Indicators = {},
...
local o = {
    Main = Color3.fromRGB(8, 9, 10),
    MainSoft = Color3.fromRGB(12, 13, 15),
    Text = Color3.fromRGB(221, 225, 222),
    TextStrong = Color3.fromRGB(247, 250, 248),
    Surface = Color3.fromRGB(15, 17, 18),
    SurfaceSoft = Color3.fromRGB(19, 21, 22),
    SurfaceHover = Color3.fromRGB(25, 29, 27),
    Elevated = Color3.fromRGB(22, 25, 24),
    ElevatedHover = Color3.fromRGB(29, 35, 32),
    Border = Color3.fromRGB(39, 44, 42),
    BorderStrong = Color3.fromRGB(61, 72, 67),
    MutedText = Color3.fromRGB(157, 166, 161),
    FaintText = Color3.fromRGB(103, 113, 108),
    ...
    TweenFast = TweenInfo.new(0.09, Enum.EasingStyle.Quart, Enum.EasingDirection.Out),
    Tween = TweenInfo.new(0.14, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
    TweenSlow = TweenInfo.new(0.20, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
    TweenSpring = TweenInfo.new(0.15, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
    TweenBack = TweenInfo.new(0.17, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
}
...
local function getV9AccentPair()
    ...
    local secondary = primary:Lerp(Color3.fromRGB(94, 126, 108), 0.58)
...
function d.CreateGUI(aa)
    ...
    aj.Size = UDim2.fromOffset(176, 30)
    aj.AnchorPoint = Vector2.new(1, 0)
    aj.Position = UDim2.new(1, -14, 0, d.isMobile and 58 or 48)
    ...
    discordLabel.Size = UDim2.new(1, -62, 1, 0)
