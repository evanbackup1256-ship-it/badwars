...
local getcustomassets = {
	['badscript/assets/liquidbounce/blatant.png'] = 'rbxasset://liquidbounce/blatant.png',
	['badscript/assets/liquidbounce/combat.png'] = 'rbxasset://liquidbounce/combat.png',
	['badscript/assets/liquidbounce/expand.png'] = 'rbxasset://liquidbounce/expand.png',
	['badscript/assets/liquidbounce/inventory.png'] = 'rbxasset://liquidbounce/inventory.png',
	['badscript/assets/liquidbounce/logo.png'] = 'rbxasset://liquidbounce/logo.png',
	['badscript/assets/liquidbounce/minigames.png'] = 'rbxasset://liquidbounce/minigames.png',
	['badscript/assets/liquidbounce/render.png'] = 'rbxasset://liquidbounce/render.png',
	['badscript/assets/liquidbounce/textgui.png'] = 'rbxasset://liquidbounce/textgui.png',
	['badscript/assets/liquidbounce/utility.png'] = 'rbxasset://liquidbounce/utility.png',
	['badscript/assets/liquidbounce/world.png'] = 'rbxasset://liquidbounce/world.png',
...
local function writeFont()
	...
	--[[writefile('badscript/assets/liquidbounce/lbfont.json', httpService:JSONEncode({
		name = 'Inter',
		faces = {
			{style = 'normal', assetId = getcustomasset('badscript/assets/liquidbounce/Inter-Light.ttf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('badscript/assets/liquidbounce/Inter-Regular.ttf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('badscript/assets/liquidbounce/Inter-Medium.ttf'), name = 'Medium', weight = 500}
		}
	}))]]
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		expandicon.Image = getcustomasset('badscript/assets/liquidbounce/expand.png')
...
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('badscript/assets/liquidbounce/blatant.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('badscript/assets/liquidbounce/render.png'),
	Size = UDim2.fromOffset(15, 9)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('badscript/assets/liquidbounce/utility.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('badscript/assets/liquidbounce/world.png'),
	Size = UDim2.fromOffset(15, 15)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('badscript/assets/liquidbounce/inventory.png'),
	Size = UDim2.fromOffset(14, 15)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('badscript/assets/liquidbounce/minigames.png'),
	Size = UDim2.fromOffset(15, 15)
})
