...
buttonicon.Image = optionsettings.Icon or getcustomasset('badscript/assets/new/allowedicon.png')
...
icon.Image = optionsettings.Tab or getcustomasset('badscript/assets/new/allowedtab.png')
icon.Parent = window
